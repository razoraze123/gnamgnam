...
CREATE TABLE IF NOT EXISTS products (
  ...
  ingredients TEXT,
  preparation TEXT[],
  poids VARCHAR(50) DEFAULT '500g',
  badge_specifique VARCHAR(100),
...
('Gnam Gnam bouillie spécial épicé', 2500, 'Délicieuse bouillie de mil enrichie à la banane mûre. Texture onctueuse et goût naturellement sucré, parfaite pour le petit-déjeuner de bébé.', 'Dès 6 mois', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400', 25),
('Gnam Gnam bouillie Spécial Céréales', 2800, 'Mélange nutritif de maïs et d''arachide grillée. Riche en protéines végétales pour une croissance optimale.', 'Dès 8 mois', 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400', 18),
('Gnam Gnam bouillie spécial Mil', 3200, 'Notre formule premium au soja, enrichie en vitamines et minéraux. Idéale pour les bébés en pleine croissance.', 'Dès 6 mois', 'https://images.unsplash.com/photo-1495521939206-a217db9df264?w=400', 12),
