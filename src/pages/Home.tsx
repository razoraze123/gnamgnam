    ...
    return (
        <main>
            ...
            <FeaturedProductsSection
                ...
                onRetry={fetchData}
            />
            <TestimonialsSection reviews={latestReviews} loading={loading} />
            <CTASection />
        </main>
    )
}
    ...
    return (
        <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-royal leading-tight mb-6">
                La nutrition <span className="gradient-text">parfaite</span> pour votre bébé
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link to="/boutique" className="btn-primary group px-8 py-4 text-white font-bold rounded-full text-lg shadow-lg flex items-center justify-center gap-2">
                    Découvrir nos bouillies
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/bienfaits" className="px-8 py-4 bg-white text-royal font-bold rounded-full text-lg shadow-lg hover:shadow-xl transition-all border-2 border-royal/10 flex items-center justify-center gap-2">
                    Nos bienfaits
                </Link>
            </div>
            <TrustBadges />
    ...
    return (
        <div className="flex items-center justify-center lg:justify-start gap-8 mt-12">
            <div className="text-center">
                <p className="text-3xl font-bold text-sage flex items-center justify-center gap-1">100<span className="text-base">%</span></p>
            ...
            <div className="w-px h-12 bg-royal/20" />
            <div className="text-center">
                <p className="text-3xl font-bold text-sage flex items-center justify-center gap-1">5<Star className="w-5 h-5 fill-sage" /></p>
...
const FEATURES = [
    { icon: <Sprout className="w-10 h-10 text-sage" />, title: 'Ingrédients Naturels', description: 'Céréales locales et fruits frais, sélectionnés avec soin pour une nutrition optimale.' },
    { icon: <Baby className="w-10 h-10 text-sage" />, title: 'Adapté à Chaque Âge', description: 'Formules spécialement conçues pour les besoins nutritionnels de chaque étape.' },
    { icon: <Zap className="w-10 h-10 text-sage" />, title: 'Sans Additifs', description: 'Aucun conservateur, colorant artificiel ou sucre ajouté. Juste le meilleur.' },
]
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {FEATURES.map((feature, index) => (
                        <div key={index} className="text-center p-8 rounded-2xl bg-sand/50 hover:bg-white hover:shadow-xl transition-all group border-2 border-transparent hover:border-sage/10">
...
function FeaturedProductsSection({ products, loading, error, onRetry }: FeaturedProductsSectionProps) {
    return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-end justify-between mb-12">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-bold text-royal mt-3">Produits phares</h2>
                    </div>
                    <Link to="/boutique" className="hidden sm:flex items-center gap-2 text-sage font-semibold hover:gap-3 transition-all">
                        Voir tout
                ...
                {error ? (
                    <ErrorState title="Oups ! Une erreur est survenue" message={error} onRetry={onRetry} />
                ) : loading ? (
                    <ProductsSkeleton />
                ) : products.length > 0 ? (
                    ...
                    <div className="text-center py-12"><p className="text-royal/60">Les produits arrivent bientôt...</p></div>
                )}

                <div className="text-center mt-8 sm:hidden">
                    <Link to="/boutique" className="inline-flex items-center gap-2 text-sage font-semibold">
...
function TestimonialsSection({ reviews, loading }: TestimonialsSectionProps) {
    return (
        <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <span className="text-sage font-semibold text-sm uppercase tracking-wider">Témoignages</span>
                    <h2 className="text-3xl sm:text-4xl font-bold text-royal mt-3">Ce que disent nos clients</h2>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12"><p className="text-royal/60">Les avis arrivent bientôt...</p></div>
                )}

                <div className="text-center mt-8">
                    <Link to="/avis" className="inline-flex items-center gap-2 px-6 py-3 bg-royal text-white font-semibold rounded-full hover:bg-royal-light transition-colors">
                        Voir tous les avis
                    </Link>
                </div>
            </div>
    ...
    return (
        <section className="py-20 bg-gradient-to-br from-royal to-royal-dark text-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold mb-6">Prêt à offrir le meilleur à votre bébé ?</h2>
                ...
                <Link to="/boutique" className="inline-block px-8 py-4 bg-sage text-white font-bold rounded-full text-lg hover:bg-sage-light transition-colors shadow-lg">
