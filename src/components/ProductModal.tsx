                        ...
                        <div className='relative px-6 py-8 -mt-10 md:mt-0 bg-white rounded-t-3xl md:rounded-none flex flex-col h-full z-10'>
                            ...
                            <div className='mt-auto'>
                                <button
                                    ...
                                    className={`w-full py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-3 shadow-lg hover:shadow-xl active:scale-${ACTIVE_SCALE} ${isOutOfStock
